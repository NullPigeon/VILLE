...
const databaseErrors: Record<string, [number, string]> = {
  ...
  INVALID_MODULE_LIKE: [400, 'Invalid module like request.'],
  INVALID_MODULE_LIKE_SNAPSHOT: [409, 'Your SCRAPY snapshot is invalid. Refresh and retry.'],
  MODULE_NOT_FOUND: [404, 'This module has not been published.'],
  OWN_MODULE_LIKE: [403, 'You cannot like a module built from your own idea.'],
  WEEKLY_MODULE_LIKE_LIMIT: [429, 'You have used all your module likes for this UTC week.'],
