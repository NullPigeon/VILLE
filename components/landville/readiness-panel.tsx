...
type Status = { storage: string; sessionConfigured: boolean; privyConfigured: boolean; ai: { configured: boolean; model: string }; moduleImages: { enabled: boolean; model: string; keyPresent: boolean }; builderEnabled: boolean; builderConfigurationPresent: boolean };
