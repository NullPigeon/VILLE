...
type Status = { storage: string; sessionConfigured: boolean; privyConfigured: boolean; ai: { configured: boolean; model: string }; moduleImages: { enabled: boolean; model: string; keyPresent: boolean }; walletTransactions: { enabled: boolean; chainId: number; mode: string }; builderEnabled: boolean; builderConfigurationPresent: boolean };
